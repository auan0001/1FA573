...
# xx = np.genfromtxt('/home/auan/1FA573/CXX/Data/binder3.txt',
#                      skip_header=0,
#                      skip_footer=0,
#                      names=True,
#                      dtype=float,
...
#
# y1 = np.genfromtxt('/home/auan/1FA573/CXX/Data/binder3.txt',
#                      skip_header=0,
#                      skip_footer=0,
#                      names=True,
#                      dtype=float,
...
#
# y2 = np.genfromtxt('/home/auan/1FA573/CXX/Data/binder3.txt',
#                      skip_header=0,
#                      skip_footer=0,
#                      names=True,
#                      dtype=float,
...
#
# y3 = np.genfromtxt('/home/auan/1FA573/CXX/Data/binder3.txt',
#                      skip_header=0,
#                      skip_footer=0,
#                      names=True,
#                      dtype=float,
...
data = np.loadtxt('/home/auan/1FA573/CXX/Data/binder3.txt').astype(float)

fig, ax = plt.subplots()
plt.grid(linestyle='dashed')
plt.title(r'4th Order Cumulant (Binder parameter)', fontsize = '22')
plt.plot(data[0,:], data[1,:], label = r'L=8', marker='x', linestyle='--', linewidth='1')
plt.plot(data[0,:], data[2,:], label = r'L=16', marker='x', linestyle='--', linewidth='1')
plt.plot(data[0,:], data[3,:], label = r'L=32', marker='x', linestyle='--', linewidth='1')
# print(data[2,:])
